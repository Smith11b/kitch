...
export default function VerifyPage() {
    ...
    return (
        <main className="flex min-h-svh flex-col items-center justify-center bg-muted p-6 md:p-10 text-secondary-blue">
            <Card aria-label={"verify-card"}className="w-full max-w-sm md:max-w-3xl">
                <CardHeader>
